...
'set the formulae
Sub putFormula(counts As Long, rows as Long, oSheet1 As Object)
  For i = 0 to 9
    oSheet1.getCellRangeByName("T1:T"& counts).ClearContents(2 ^ i)
  Next i
  For i = 1 To counts
    oSheet1.getCellRangeByName("T"&i).Formula = "=COUNTIF(J$2:J$" & rows &";1)"
  Next i
End Sub
...
Sub calculateRunTime(oDoc as Object, oSheet as Object, rowIndex As Long, counts As Long)
...
Sub main
  ...
  For i = minCount to maxCount+1 Step stepSize
